        ...
        for (var key in jsonObj) {
           ...
           if (jsonObj.hasOwnProperty(key)) {
			  ...
			  if(jsonObj[key].category == "list"){
				  ...
				  eachGameLine.innerHTML = "<div class='game-line'><div class='game-line thumb'><img src='images/games/thumb/" + jsonObj[key].thumbImageUrl + "' border='0' title='' alt='' /></div><div class='game-line info game' id='" + jsonObj[key].id + "'><div class='game-line title' id='" + jsonObj[key].id + "'>" + jsonObj[key].title + "</div><div class='game-line platform'><ul><li class='steam'></li><li class='drm'></li><li class='windows'></li></ul></div><div class='buttons'><div class='game-line price' id='cart-" + jsonObj[key].id + "'>" + jsonObj[key].price + "</div><div class='game-line addToCart' id='game-cart-" + jsonObj[key].id + "'>Add to Cart</div></div><div class='game-line game-descr' id='game-" + jsonObj[key].id + "'><div class='youtube-video'><iframe width='100%' height='360' src='" + jsonObj[key].videoUrl + "' frameborder='0' allowfullscreen></iframe></div><div class='selected-game-info'><div class='description'>" + jsonObj[key].description + "</div><div class='detailes'><div class='section'><h2>Developer:</h2><a href='" + jsonObj[key].developerLink + "'>" + jsonObj[key].developer + "</a></div><div class='section'><h2>More Information:</h2><a href='#'>System Requirements</a></div></div></div></div></div></div> <!-- //Game 1 -->";
